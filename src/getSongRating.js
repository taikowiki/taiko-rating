...
export function getCompensated(percentage) {
    ...
    if (multiplied < 600000) {
        compensated = mathjs
            .subtract(mathjs.exp(mathjs.multiply(mathjs.divide(mathjs.log(400001), 600000), multiplied)), 1)
            .valueOf();
    }
    else if (multiplied < 750000) {
        compensated = mathjs
            .add(mathjs.multiply(mathjs.divide(5, 3), mathjs.subtract(multiplied, 600000)), 400000)
            .valueOf();
    }
    else if (multiplied < 950000) {
        compensated = mathjs
            .add(mathjs.multiply(mathjs.divide(3, 2), mathjs.subtract(multiplied, 750000)), 650000)
            .valueOf();
    }
    else {
        compensated = mathjs
            .add(mathjs.multiply(mathjs.divide(150000, mathjs.log(16)), mathjs.log(mathjs.add(mathjs.divide(mathjs.subtract(multiplied, 950000), 10000), 1))), 950000)
            .valueOf();
    }
    return compensated;
}
//# sourceMappingURL=getSongRating.js.map